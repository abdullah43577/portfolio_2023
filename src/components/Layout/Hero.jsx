      ...
      <div className="max-w-7xl flex flex-col xl:flex-row items-center justify-between mx-auto gap-8 px-8 xl:px-0">
        <section className="xl:w-[50%] w-auto">
          ...
          <section className="flex flex-wrap gap-4">
            <a href="https://github.com/abdullah43577" target="_blank" rel="noreferrer" className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
            ...
            <a href="https://twitter.com/officialayo540" target="_blank" rel="noreferrer" className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
            ...
            <a href="https://www.linkedin.com/in/ayo540/" target="_blank" rel="noreferrer" className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
            ...
            <a href="https://web.facebook.com/profile.php?id=100070875720063" target="_blank" rel="noreferrer" className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
              <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="18" width="24" viewBox="0 0 512 512" className="dark:text-white">
            ...
            <a href="mailto:officialayo540@gmail.com" target="_blank" rel="noreferrer" className="tech_stack flex items-center gap-1 border-b border-zinc-200 cursor-pointer pb-1">
              <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="18" width="24" viewBox="0 0 512 512" className="dark:text-white">
