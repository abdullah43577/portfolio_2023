        ...
        <section className="my-10 px-8 xl:px-0">
          ...
          <section className="checklist flex-wrap max-w-full xl:max-w-[80%] text-sm">
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-green-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="#" target="_blank" rel="noreferrer" className="hover:underline text-green-600 font-medium">
                Dapo Adedire
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="#" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white text-sm">
                Jonas Schmedtmann
              </a>
            </div>
