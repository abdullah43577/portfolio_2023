...
export default function About() {
  ...
  useEffect(() => {
    document.title = 'About | Abdullah Ayoola';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col-reverse xl:flex-row items-center xl:items-start justify-between px-8 xl:px-0">
          <div className="max-w-full xl:max-w-[50%]">
            <h2 className="font-bold text-lg xl:text-3xl dark:text-white">Hi there!, I'm Abdullah Ayoola, a Fullstack developer based in Lagos, Nigeria. Driven to create cutting-edge solutions.</h2>

            <p className="my-6 text-sm xl:text-base">
              I'm a versatile fullstack developer, nimble typist, and avid gamer based in Lagos, Nigeria. I bring a passion for creating seamless digital experiences and solving complex problems through code. As a developer, I've honed my skills in
              React and NodeJS, ensuring that I can bring a well-rounded approach to any project.
              <br />
              <br />
              Beyond coding, I'm a skilled typist, navigating between lines of code with speed and precision. When I'm not immersed in development or typing away, you'll find me in the gaming realm, where strategic thinking and quick reflexes meet
            ...
            <blockquote className="border text-sm border-zinc-200 rounded-md w-full p-4 italic relative dark:border-zinc-600">
              <div className="text-center">
                "Should our digital paths cross, feel free to pop in and say hi! Picture this: a virtual rendezvous where we can share stories over code, sip on the pixels of our favorite programming languages, and make the surreal world of tech a
                tad more personal. Looking forward to our encounter in the digital ether!"
              </div>

              <svg className="absolute top-0 left-0 z-[-1]" fill="#d1d5db" xmlns="http://www.w3.org/2000/svg" height="40" width="40" viewBox="0 0 448 512">
                <path d="M0 216C0 149.7 53.7 96 120 96h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V320 288 216zm256 0c0-66.3 53.7-120 120-120h8c17.7 0 32 14.3 32 32s-14.3 32-32 32h-8c-30.9 0-56 25.1-56 56v8h64c35.3 0 64 28.7 64 64v64c0 35.3-28.7 64-64 64H320c-35.3 0-64-28.7-64-64V320 288 216z" />
              </svg>

              <svg className="absolute top-0 right-0 z-[-1]" fill="#d1d5db" xmlns="http://www.w3.org/2000/svg" height="40" width="40" viewBox="0 0 448 512">
          ...
          <div className="mb-6 xl:mb-0 dark:text-white">
            ...
            <div className=" flex items-center justify-between my-4">
              ...
              <a href={CV} download="Ayoola Abdullah Resume" className="border border-transparent hover:border-zinc-200 cursor-pointer p-3 rounded-md dark:hover:border-zinc-600">
        ...
        <section className="my-10 px-8 xl:px-0">
          <h2 className="text-lg xl:text-xl font-bold dark:text-white">Developers I'd like to meet</h2>
          <p className="mt-3 mb-6 max-w-full xl:max-w-[80%]">
            Here are the list of developers I'd like to meet in real life, I've interacted with some through the online space, but I'd love to meet them in real life. Inspired by{' '}
            <a href="https://victoreke.com" target="_blank" rel="noreferrer" className="underline text-blue-500">
              victor eke
            </a>{' '}
            heroes list, guess I've still got a long way to go!😂
          </p>

          <section className="checklist flex-wrap max-w-full xl:max-w-[80%] text-sm">
            <div className="flex items-center gap-2 px-6 py-1 border border-gray-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              <label htmlFor="myCheckBox" className="cursor-not-allowed">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-3xl dark:text-zinc-300 text-zinc-600" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://twitter.com/traversymedia" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Brad Traversy
              </a>
            </div>

            <div className="flex items-center gap-2 px-6 py-1 border border-green-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              <label htmlFor="myCheckBox" className="cursor-not-allowed">
                <svg fill="#22c55e" stroke="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-3xl dark:text-primary-color text-secondary-color" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://twitter.com/dapo_adedire" target="_blank" rel="noreferrer" className="hover:underline text-green-600 font-medium">
                Dapo Adedire
              </a>
            </div>

            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              <label htmlFor="myCheckBox" className="cursor-not-allowed">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-3xl dark:text-zinc-300 text-zinc-600" aria-hidden="true" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 5c-1.103 0-2 .897-2 2v10c0 1.103.897 2 2 2h10c1.103 0 2-.897 2-2V7c0-1.103-.897-2-2-2H7zm0 12V7h10l.002 10H7z"></path>
                </svg>
              </label>
              <a href="https://twitter.com/jonasschmedtman" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white text-sm">
                Jonas Schmedtmann
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="https://twitter.com/thenetninjauk" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Net Ninja
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="#" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Victor Eke
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="https://twitter.com/ChukwudobeMicah" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Chukwudobe Micah
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="https://twitter.com/The_Jazzmann" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Abots
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="https://twitter.com/DaveyHert" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                David Herbert
              </a>
            </div>
            ...
            <div className="flex items-center gap-2 px-6 py-1 border border-zinc-200 rounded-md dark:border-gray-800 dark:bg-zinc-800">
              ...
              <a href="https://twitter.com/bilal_muili" target="_blank" rel="noreferrer" className="hover:underline text-zinc-600 font-medium dark:text-white">
                Bilal Dev
              </a>
            </div>
          </section>
        ...
        <section className="px-8 xl:px-0">
          ...
          <section className="socials flex-wrap max-w-full xl:max-w-[80%] text-sm">
